<link rel="stylesheet" href="./lib/kanban.css" />
<script src="./lib/kanban.js"></script>
<div id="kanbanmusume">
  <img src="./src/kanban.png" width="250" height="389" class="kanbanimg" alt="" />
</div>
<div id="hitokoto" class="shadow">
  <a href="https://github.com/elpwc/ANIME-SEIRI.web/issues/new" target="_blank" class="bugreporttext">
